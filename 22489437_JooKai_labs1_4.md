...
1. The following code was used to apply a policy to allow only my username (22489437@student.uwa.edu.au) to access my S3 bucket:
```
ROOT_DIR = '.'
ROOT_S3_DIR = '22489437-cloudstorage'
REGION = 'ap-southeast-2'
    ...
    "Statement": [
        {
            ...
            "Principal": "*",
            "Action": "s3:*",
            "Resource": "arn:aws:s3:::22489437-cloudstorage/*",
            "Condition": {
                "StringNotLike": {
...
<br/><br/>
![AWS Policy](https://github.com/Bsubs/CITS5503-Cloud-Computing/blob/main/lab4/Screenshot%202023-08-24%20155218.png)
...
3. The following file named `enc_test.txt` will be the subject of the encryption and decryption for the next step
<br/><br/>
